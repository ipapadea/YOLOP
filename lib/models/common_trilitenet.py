...
class Encoder(nn.Module):
    ...
    def forward(self, input):
        ...
        return [out_encoder, inp1, inp2], [output0_cat, output1_cat, out_encoder]
...
class UpSimpleBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        super().__init__()
        self.deconv = nn.ConvTranspose2d(in_channels, out_channels, 2, stride=2, padding=0, output_padding=0,
                                         bias=False)
...
class DetectHead(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        self.fpn = FPN(in_channels_list=[model_cfg['chanels'][4], model_cfg['chanels'][4], model_cfg['chanels'][4]],
