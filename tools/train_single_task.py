...
from lib.core.loss_single_task import get_loss
from lib.core.function_single_task import train
from lib.core.function_single_task import validate
from lib.core.general import fitness
# from lib.models import get_net
from lib.models import TwinLite_2_object_detection_single_task as net
...
def main():
    ...
    model = net.TwinLiteNet_2_ObjectDetectionSingleTask().to(device)
    # print("load finished")
